...
### 3
1. 我们接下来将要写的历史的开始节点是第140届奥林匹克运动会（前220年至前216年），包括下述事件：(2)希腊人所谓的同盟战争，第一亚该亚联盟和腓力（五世）——德米特里乌斯之子，珀尔修斯之父——率领下的马其顿对战埃托利亚联盟。
...
6. 我们无法就是从历史的某一个特定事件把握到这一点，而必须在同一时间了解整个世界的布局、进程并逐个对比每一个注明的势力，否则厘清他们之间的关系是不可能的。
